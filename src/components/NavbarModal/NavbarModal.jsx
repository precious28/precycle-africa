  ...
  return (
    ...
    >
      <Modal.Body className="mb-5 customBackground">
        <Modal.Header className="closeModal" closeButton></Modal.Header>
        <Stack
          gap={3}
        ...
        >
          <Container fluid="md mt-5">
            ...
            <div className=" fw-bold mySecondary fs-3 mt-4">
              Schedule your plastic waste pickup
            </div>
            <div className="mt-4 mb-4">
              We collect Pure Water sachets, PET plastic bottles (PET), and
              other plastic products.
            </div>
            <div className="mb-4">
              Contact us to pickup your plastic waste using any of the following
              medium:
            </div>
            <Stack gap={4}>
              <Stack
