    ...
    <HomeLayoutWrapper>
      <>
        ...
        <div className="d-flex align-items-center justify-content-center customHeight fs-2 fw-bold mySecondary lh-sm text-center ">
          <Col lg={4}>A continental Plastic Problem we Need to Understand</Col>
        </div>

        <Container className="mb-5">
          <CardGroup className="gap-4">
            <Card className="shadow">
              <Card.Body className="customBackground">
                <Card.Img className="imageHeight p-3" src={Recycle1} />
                <Card.Text className="fs-6 p-5 blackText">
        ...
        <div className="customBackground p-2 p-md-5">
          ...
          <Container className="mt-5">
            <Row className="gap-5">
              ...
              <Col md={5}>
                <Stack gap={4}>
                  <div className="mySecondary fs-6  fw-bold">
                    OFFSET POLUTION AND POVERTY
                  </div>
                  <div className="fs-5 fw-bold">Impact Patnership</div>
                  <div>
                  ...
                  <Button className="pickupBtn  p-2 col-5" size="md">
                    Learn More
                  </Button>
                </Stack>
              </Col>
          ...
          <Row className="gap-5">
            <Col sm={5}>
              <Stack gap={4}>
                ...
                <div className="fs-5 fw-bold">Waste to Wealth</div>
                <div>
                ...
                <Button className="pickupBtn p-2 col-6" size="md">
                  Waste Pickup
                </Button>
              </Stack>
            </Col>
            ...
            <Row className="gap-4">
              ...
              <Col sm={5}>
                <Stack gap={3} className="">
                  ...
                  <div className="fs-5 fw-bold">Volunteer for Change</div>
                  <div className="">
        ...
        <Container className="mb-5">
          <div className=" d-flex justify-content-center align-items-center p-2 p-md-4 blackText">
            <CardGroup className="gap-5 rounded-top">
              <Card className="shadow">
                <Card.Img variant="top" src={Training2} />
                <Card.Body className="customBackground p-3 p-md-5">
